...
class ListodoListItem extends StatelessWidget {
  final ListodoList listodoList;

  ListodoListItem({this.listodoList});
                    ...
                    child: Row(
                      children: [
                        ...
                        FittedBox(
                          fit: BoxFit.fitWidth,
                          child: Text(
                            '${listodoList.creator.firstname} ${listodoList.creator.lastname[0]}.',
                            style: TextStyle(
                              fontSize: 22,
